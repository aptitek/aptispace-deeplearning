...
La sommation $D_{\text{KL}} = H_1 + H_2 - H_3$ donne la **formule standard** [@munoz_nd] :
...
Dans l'implémentation standard du VAE, les covariances sont **diagonales** : $\boldsymbol{\Sigma}_1 = \text{diag}(\sigma_1^2, \ldots, \sigma_k^2)$ et $\boldsymbol{\Sigma}_2 = \mathbf{I}$ (l'*a priori* standard). La formule se simplifie considérablement :
