## Rotary Position Embedding (RoPE) : Géométrie Rotationnelle
...
:::: {.card-header}
🔄 Simulation : RoPE — Rotation des Tokens dans l'Espace Complexe
::::

:::: {.card-control-row .sim-controls-row style="flex-wrap: wrap; gap: 0.5rem;"}
```{ojs}
//| echo: false
...
### Implémentation dans LLaMA : Optimisation par Complexes
