...
Où :
* $\frac{\partial \mathcal{L}}{\partial a}$ est la sensibilité de la perte par rapport à la sortie du neurone
* $\frac{\partial a}{\partial z} = \sigma'(z)$ est la dérivée de la fonction d'activation
* $\frac{\partial z}{\partial w} = x$ est la valeur d'entrée connectée à ce poids
:::
