...
Où :
* $\mathbf{a}^l$ est le vecteur d'activations de la couche $l$
* $\mathbf{W}^l \in \mathbb{R}^{n_l \times n_{l-1}}$ est la matrice des poids de la couche $l$
* $\mathbf{a}^{l-1}$ est le vecteur d'activations de la couche précédente $l-1$
* $\mathbf{b}^l$ est le vecteur des biais de la couche $l$
* $\sigma$ est la fonction d'activation, appliquée élément par élément
:::
