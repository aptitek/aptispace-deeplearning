...
La théorie des jeux garantit l'équilibre uniquement dans des espaces convexes et simples. Les réseaux de neurones fonctionnent dans des espaces de paramètres non-convexes — rien ne garantit donc la convergence, et l'entraînement requiert un équilibre délicat entre les deux adversaires.
