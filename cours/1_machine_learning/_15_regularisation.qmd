...
```{ojs}
//| echo: false
viewof regType = Inputs.select(
  new Map([
    ["Lasso (Pénalité L1 — Sélection Sparsity)", "lasso"],
    ["Ridge (Pénalité L2 — Réduction Variance)",  "ridge"],
    ["ElasticNet (Pénalité Hybride L1 + L2)",      "elastic"]
  ]),
  { value: "lasso", label: "🛠️ Type de Régularisation" }
)
