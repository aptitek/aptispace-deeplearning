...
Si le sur-apprentissage (une variance excessive) est la maladie, la régularisation en est le remède. La régularisation impose une contrainte mathématique de "lissage" pour favoriser la généralisation en pénalisant la complexité excessive du modèle [@wiki_early_stopping].
...
* **ElasticNet :** Dans les cas où les données présentent de nombreuses variables fortement corrélées entre elles, on utilise cet hybride. Il combine littéralement le meilleur des deux mondes en fusionnant la contrainte circulaire (L2) et la contrainte en losange (L1).
...
2. **Auditabilité :** Il simplifie drastiquement l'interprétabilité du modèle pour les instances de gouvernance, rendant l'IA transparente et explicable ("*White Box*").