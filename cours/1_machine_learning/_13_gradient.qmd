...
```{ojs}
//| echo: false
import { createTabsetWatcher as createTabsetWatcherGrad } from "../../assets/js/custom/card.js"

mutable optType = "momentum"

_optTypeWatcher = {
  const w = createTabsetWatcherGrad(
    ".opt-type-tabset",
    {
      "Momentum": "momentum",
      "RMSprop": "rmsprop",
...
render3DDescent = {
  runGradientSimulation(optType, optParam, triggerBtn, {
