...
L'augmentation de données est une solution pragmatique pour pallier le manque de diversité ou le faible volume des jeux de données. C'est une étape particulièrement critique pour assurer la robustesse d'un modèle lors de son déploiement en production, notamment dans les domaines de la vision par ordinateur [@ibm_overfitting; @sandru_2022_augmentation].
...
::::: {.card-header}
Augmentation de Données : Vue Machine
:::::
...
```{ojs}
//| echo: false
import { updateDataAugmentation } from "../../assets/js/custom/augmentation.js"
