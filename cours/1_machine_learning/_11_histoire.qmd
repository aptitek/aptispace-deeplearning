...
L'IA n'est pas née en 2023. C'est une histoire de soixante ans, faite d'espoirs fous, de désillusions et de renaissances — comme un pendule qui oscille entre deux grandes idées : faire obéir les machines à des règles écrites à la main (**IA symbolique**) ou leur apprendre à partir d'exemples, comme le ferait un enfant (**connexionnisme**) [@groumpos_2023_ai; @wiki_timeline_ml].
...
| :----------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](../../assets/expert_systems.png){width=80px} | *Paradoxe* : Domination de l'IA symbolique menant au 2nd Hiver, pendant que la Rétropropagation du gradient (Hinton, LeCun) est popularisée dans l'ombre. |
::::
...
| :---------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](../../assets/alexnet.jpg){width=80px} | *Triomphe connexionniste* : Grâce à la convergence du Big Data et des GPUs, le réseau AlexNet pulvérise les méthodes statistiques classiques. |
::::
