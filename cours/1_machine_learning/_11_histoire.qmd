...
L'IA n'est pas née en 2023. C'est une histoire de soixante ans, faite d'espoirs fous, de désillusions et de renaissances — comme un pendule qui oscille entre ces deux grandes idées [@groumpos_2023_ai; @wiki_timeline_ml].
...
| :----------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](../../assets/expert_systems.png){width=80px} | *Paradoxe* : Domination de l'IA symbolique menant au 2nd Hiver, pendant que la Rétropropagation du gradient (Hinton, LeCun) is popularisée dans l'ombre. |
::::
...
## 🔍 Détails : Les 4 grandes époques de l'histoire de l'IA
