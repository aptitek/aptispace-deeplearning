...
<div class="row g-4 align-items-center justify-content-center px-3 pt-3">
  <div class="col-md-5">
    <div class="pooling-grid-container">
      <div class="pooling-grid-title">Image d'Entrée (4x4)</div>
```{ojs}
//| echo: false
renderInputGrid = {
...
```
  ...
  <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
    <div class="pooling-separator">➡️</div>
  </div>

  <div class="col-md-5">
    <div class="pooling-grid-container">
      <div class="pooling-grid-title">Sortie Pooled (2x2)</div>
```{ojs}
//| echo: false
renderOutputGrid = {
